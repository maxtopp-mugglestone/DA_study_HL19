...
def match_tune_and_chroma(lhc, config):
...
# ==================================================================================================
# --- Function to add linear coupling ??? CHECK
# ==================================================================================================
...
# ==================================================================================================
# --- Rematch tune and chromaticity without coupling correction CHECK IF NEEDED
# ==================================================================================================
...
def assert_tune_chroma_coupling(collider, config_collider):
    ...
    for line_name in ["b1", "b2"]:
        ...
        assert np.isclose(
            tw.dqy,
            config_collider['tuning']["dqy"][line_name],
            rtol=1e-2,
        ), (
...
# ==================================================================================================
# --- Function to compute the number of collisions in the IPs (used for luminosity computation) CHECK NEEDED
# ==================================================================================================
...
def record_final_luminosity(collider, config_bb, l_n_collisions, crab):
    ...
    def twiss_and_compute_lumi(collider, config_bb, l_n_collisions, crab):
        ...
        for n_col, ip in zip(l_n_collisions, l_ip):
            try:
                L = xt.lumi.luminosity_from_twiss( #FUNCTION NOT IMPLEMENTED YET
